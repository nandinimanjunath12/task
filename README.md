...
// Function to print avatar box
fun printAvatar(name: String) {
    printBorder()
    println("|                                      |")
    println("|              ${name.first().toUpperCase()}                       |")
    println("|                                      |")
    printBorder()
}

// Function to display one profile
fun displayProfile(user: UserProfile, index: Int) {
    printBorder()
    println("User Profile #$index")
    printBorder()
